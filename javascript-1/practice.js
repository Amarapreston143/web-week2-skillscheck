...
//The value of the firstName key should be your name as a string. The value of the property state should be your current state or providence of residence as a string. 
//The value of age should be your age as a number. greeter should be a method that returns the string 'Hello! 
...
//Inside of the bigOrSmall function, create a new array called 'answers'. Then, loop over the passed in arr parameter, and 
//check to see if the number in the array is GREATER than 100. If it is, push 'big' as a string to the answers array. 
...
//Using a for loop, loop over the passed in array IN REVERSE (this means your counter should decrement), and then add each item to the 
...
// Code Here
var doubled = myNumbers.map(e => e * 2)
...
// Code Here
var filtered = myNumbers.filter(e => e > 100)
//////////////////PROBLEM 16////////////////////
...
// Code Here
var total = myNumbers.reduce((acc, e) => acc += e, 0)
//////////////////PROBLEM 17////////////////////
...
// It passed on Jasmine, but when I finished #20 it now says failed.
//////////////////PROBLEM 20////////////////////
